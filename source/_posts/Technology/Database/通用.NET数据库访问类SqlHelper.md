---
title: 通用.NET数据库访问类SqlHelper
date: 2021-06-19 04:04:17
updated: 2021-06-19 16:26:17
description: 通用.NET数据库访问类SqlHelper
keywords: 通用,.NET,数据库,访问类,SqlHelper
tags:
  - CSharp
  - .NET
categories:
 ...
 * --------获取连接字符串--------
 * 如果要获取连接数据连接对象或字符串的话，先要修改Configuration中的ConnectionStrings为"ConnectionString"才能调用。
 */

namespace ZhaiFanHua.DAL
{
    /// <summary> 
    /// SqlServer数据访问帮助类 
    /// </summary> 
